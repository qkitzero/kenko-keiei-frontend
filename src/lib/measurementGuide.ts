...
const DESCRIPTIONS_BY_CODE: Record<string, string> = {
  ...
  back_strength:
    "背中と腰を伸ばす方向に引き上げる力です。手の力を見る握力、脚の力を見る立ち上がりに対して、体の後ろ側の筋力を見ます。2 回測ります。",
  cs30: "30 秒間にイスから立ち座りを何回できるかを測ります。脚の筋持久力の目安です。",
  sit_and_reach:
    "脚を伸ばして座り、上体を前に倒せる距離を測ります。背中から脚の裏側の柔軟性の目安です。",
  stick_reaction:
    "落下する棒をつかむまでの距離から反応の速さを測ります。距離が短いほど速い反応です。3 回測り、判定に使うのは最も良い 1 回ではなく測った回の平均です。",
  seated_stepping_20s:
    "イスに座ったまま、20 秒間に足を踏みかえた回数を測ります。立たずに行うので、素早く足を動かす力を安全に見られます。",
  ...
  two_step:
    "できるだけ大きく 2 歩進んだ距離（2歩幅）を測り、身長で割った 2ステップ値で評価します。歩幅は歩く速さや脚の筋力と関係し、身長で割ることで体格の差を除きます。身長を記録していない測定では判定が付きません。",
  timed_up_and_go:
